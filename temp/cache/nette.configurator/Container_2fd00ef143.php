<?php
// source: /srv/config/common.neon
// source: /srv/config/services.neon
// source: array
...
class Container_2fd00ef143 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Core\Controllers\BaseController' => [['01']],
		'Apitte\Core\UI\Controller\IController' => [['01']],
		'App\Core\Controllers\ProductsController' => [['01']],
		...
		'ArrayAccess' => [2 => ['application.1', 'application.3', 'application.4']],
	...
	public function createService01(): App\Core\Controllers\ProductsController
	{
		return new App\Core\Controllers\ProductsController;
	}
	...
	public function createServiceApi__core__schema(): Apitte\Core\Schema\Schema
	{
		return $this->getService('api.core.schema.hydrator')->hydrate([
			[
				'handler' => ['class' => 'App\Core\Controllers\ProductsController', 'method' => 'index'],
				'id' => null,
				'tags' => [],
				'methods' => ['GET'],
				'mask' => '/api/base/products',
				'parameters' => [],
				'responses' => [],
				'negotiations' => [],
				'attributes' => ['pattern' => '/api/base/products'],
	...
	{
		$service = new App\UI\Product\ProductPresenter($this->getService('database.default.explorer'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	{
		return new Nette\Caching\Storages\FileStorage('/srv/temp/cache', $this->getService('cache.journal'));
	}
	...
	public function createServiceDatabase__default__connection(): Nette\Database\Connection
	{
		$service = new Nette\Database\Connection(
			'mysql:host=mysql_db;dbname=my_database',
			/*sensitive{*/'my_user'/*}*/,
			/*sensitive{*/'my_password'/*}*/,
			[],
		);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_2fd00ef143 $container,
			) {
			}
